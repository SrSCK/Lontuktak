...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F5EE] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-[#EFECE3] rounded-sm flex items-center h-16 lg:h-[65px] px-4">
            <div className="flex items-center justify-center w-8 h-8 mr-4">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_3312_1073)">
                  <path
      ...
      {/* Bottom Links */}
      <div className="flex justify-between items-center w-full max-w-sm sm:max-w-md lg:max-w-[381px] text-[#938D7A] font-['Georama'] text-sm lg:text-base font-normal tracking-[0.24px]">
        <button
          onClick={() => navigate("/signup")}
          className="hover:text-[#7A7460] transition-colors duration-200"
        >
          Create an account
        </button>
        <button className="hover:text-[#7A7460] transition-colors duration-200">
          Forgot Password
        </button>
      </div>
    </div>
